...
normal_items = [ItemNormal("N1", "经验药水", "获得200点经验", 500,  N1),
                ...
                ItemNormal("N11", "新手礼包", "里面有冒险家公会给予的新手物资", 0, N11),
                ]
...
special_items = [ItemSpecial("SP1", "强化石", "用来强化身上的部位，前往铁匠铺使用", 200), ItemSpecial("SP2", "改名卡", "可以用来修改名字，改名时消耗", 1000000)]
...
# 上架商店的物品
on_store_items = {"SP1", "SP2", "N1", "N2", "N10", "N3", "N4", "N5", "N6", "N7", "N8", "N9"}
store_items = []
