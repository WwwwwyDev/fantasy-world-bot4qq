...
equip_items = [ItemEquip("EQ1", "树棍", "地上捡的树枝做的棍子", 1000, 0, StatusAdd(attack=50)),
               ...
               ItemEquip("EQ9", "勇者盔", "传说中的勇者戴过的头盔", 10000000, 1, StatusAdd(defense=500, defense_percentage_add=0.1)),
               ItemEquip("EQ10", "勇者上装", "传说中的勇者穿过的衣服", 10000000,  2,
                         StatusAdd(defense=1000, blood_max=5000, defense_percentage_add=0.2)),
               ItemEquip("EQ11", "勇者下装", "传说中的勇者穿过的裤子", 10000000,  3, StatusAdd(defense=500, defense_percentage_add=0.1)),
               ItemEquip("EQ12", "勇者鞋", "传说中的勇者穿过的鞋子", 10000000,  4, StatusAdd(speed=20, defense=200, defense_percentage_add=0.1)),
...
# 装备掉落
equip_dropping = copy.deepcopy(equip_items)
equip_dropping_p = []
for item_temp in equip_dropping:
    equip_dropping_p.append(1/item_temp.price)
