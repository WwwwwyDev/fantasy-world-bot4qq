...
all_items = [ItemSpecial("SP1", "强化石", "用来强化身上的部位，前往铁匠铺使用", 200, True),
             ItemNormal("N1", "经验药水", "获得100点经验", 500, True, N1),
             ...
             ItemEquip("EQ8", "圣剑", "传说中的勇者用过的剑", 10000000, True, 0,
             ...
             ItemEquip("EQ10", "圣者上装", "传说中的勇者穿过的衣服", 10000000, True, 2, StatusAdd(defense=1000, blood_max=5000)),
             ...
             ItemEquip("EQ14", "神剑", "只有神才能用的剑🗡️上面充满着神秘的气息", 500000000, True, 0,
